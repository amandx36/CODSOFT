...
user_input = {
           ...
           "amt" : float(input("Enter the Amount :>")).strip(),
           "Gender" : input("M/F :>").strip(),
           "city" : input("Enter the city :>").strip() ,
           "Zip" : int(input("Enter the zip code :>")).strip(),
           "Lat" : float(input("Enter the latitude :>")),
           "long" : float(input("Enter the longitude")),
           "city_pop" : int(input("Enter the city population :>")).strip() ,
...
user_data = pd.get_dummies(user_data , columns= ['category','states'])
